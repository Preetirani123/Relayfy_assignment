                ...
                '<li class = "listclass">' +
                    '<a href="#">' +
                      '<div class = "imageclass">' +
                        '<img src="content/assets/productImages/' + orderLineItem.product.image + '"/>' + '</div>' +
                      '<div class = "textclass">' +
                        ...
                        (typeof(orderLineItem.product.options) == "undefined" ?
                            ...
                            buildOptions(orderLineItem.product.options)) + '</div>' +
                    '</a>' +
...
// Randomly changing header color

var menu = document.getElementById("awesome")
...
function HeaderColor(){
  ...
  menu.style.color = colorInput;
}

setInterval("HeaderColor()",2000);

// Alert after clicking place order
